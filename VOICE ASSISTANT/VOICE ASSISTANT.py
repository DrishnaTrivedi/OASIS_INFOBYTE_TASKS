...
def takecommand():
    ...
    speaker.Speak("Hello, I'm your virtual assistant! From telling you the time, date, and day, to searching the web or opening apps – just say the word, and let the magic unfold!")
    print("listening...")
